 ...
 var dzSparkLine = function(){
	...
	var barChart1 = function(){
		if(jQuery('#barChart_1').length > 0 ){
			...
			const barChart_1gradientStroke_2 = barChart_1.createLinearGradient(0, 0, 0, 250);
			barChart_1gradientStroke_2.addColorStop(0, "rgba(8, 165, 188, 1)");
			barChart_1gradientStroke_2.addColorStop(1, "rgba(8, 165, 188, 1)");

			const barChart_1gradientStroke_3 = barChart_1.createLinearGradient(0, 0, 0, 250);
			barChart_1gradientStroke_3.addColorStop(0, "rgba(8, 188, 29, 1)");
			barChart_1gradientStroke_3.addColorStop(1, "rgba(8, 188, 29, 1)");

			const barChart_1gradientStroke_4 = barChart_1.createLinearGradient(0, 0, 0, 250);
			barChart_1gradientStroke_4.addColorStop(0, "rgba(255, 95, 4, 1)");
			barChart_1gradientStroke_4.addColorStop(1, "rgba(255, 95, 4, 1)");

			const barChart_1gradientStroke_5 = barChart_1.createLinearGradient(0, 0, 0, 250);
			barChart_1gradientStroke_5.addColorStop(0, "rgba(188, 76, 8, 1)");
			barChart_1gradientStroke_5.addColorStop(1, "rgba(188, 76, 8, 1)");

			const barChart_1gradientStroke_6 = barChart_1.createLinearGradient(0, 0, 0, 250);
			barChart_1gradientStroke_6.addColorStop(0, "rgba(30, 202, 184, 1)");
			barChart_1gradientStroke_6.addColorStop(1, "rgba(30, 202, 184, 1)");
			...
			new Chart(barChart_1, {
				...
				data: {
					...
					labels: ["Amine Farah", "Adil ben Saleh", "Amine Tahiri", "Jamal Radi", "Hassan Yahyaoui"],
					datasets: [
						{
							...
							borderWidth: "0",
							backgroundColor: [barChart_1gradientStroke_2, barChart_1gradientStroke_3, barChart_1gradientStroke_4, barChart_1gradientStroke_5, barChart_1gradientStroke_6],
						}
					]
				},
				options: {
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			const barChart_2gradientStroke_2 = barChart_2.createLinearGradient(0, 0, 0, 250);
			barChart_2gradientStroke_2.addColorStop(0, "rgba(143, 160, 90, 1)");
			barChart_2gradientStroke_2.addColorStop(1, "rgba(143, 160, 90, 1)");

			const barChart_2gradientStroke_3 = barChart_2.createLinearGradient(0, 0, 0, 250);
			barChart_2gradientStroke_3.addColorStop(0, "rgba(0, 115, 168, 1)");
			barChart_2gradientStroke_3.addColorStop(1, "rgba(0, 115, 168, 1)");

			const barChart_2gradientStroke_4 = barChart_2.createLinearGradient(0, 0, 0, 250);
			barChart_2gradientStroke_4.addColorStop(0, "rgba(235, 92, 115, 1)");
			barChart_2gradientStroke_4.addColorStop(1, "rgba(235, 92, 115, 1)");

			const barChart_2gradientStroke_5 = barChart_2.createLinearGradient(0, 0, 0, 250);
			barChart_2gradientStroke_5.addColorStop(0, "rgba(15, 161, 190, 1)");
			barChart_2gradientStroke_5.addColorStop(1, "rgba(15, 161, 190, 1)");
			...
			new Chart(barChart_2, {
				...
				data: {
					defaultFontFamily: 'Poppins',
					labels: ["Information fiable", "Information pertinente", "Information d'actualité", "Information accessible"],
					datasets: [
						{
							label: "My First dataset",
							data: [85, 59, 70, 79],
							borderColor: 'rgba(54, 48, 98, 1)',
							borderWidth: "0",
							backgroundColor: [barChart_2gradientStroke_2, barChart_2gradientStroke_3, barChart_2gradientStroke_4, barChart_2gradientStroke_5], 
							hoverBackgroundColor: 'rgba(54, 48, 98, 1)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke3.addColorStop(0, "rgba(188, 76, 8, 1)");
			lineChart_3gradientStroke3.addColorStop(1, "rgba(188, 76, 8, 1)");

			const lineChart_3gradientStroke4 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke4.addColorStop(0, "rgba(8, 188, 29, 1)");
			lineChart_3gradientStroke4.addColorStop(1, "rgba(8, 188, 29, 1)");

			const lineChart_3gradientStroke5 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke5.addColorStop(0, "rgba(8, 165, 188, 1)");
			lineChart_3gradientStroke5.addColorStop(1, "rgba(8, 165, 188, 1)");
			...
			new Chart(lineChart_3, {
				...
				data: {
					...
					datasets: [
						{
							label: "Ballayage manuel",
							data: [60, 59, 60, 55, 60, 58, 59],
							borderColor: lineChart_3gradientStroke1,
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(54, 48, 98, 0.5)'
						}, {
							label: "Ballayage mécanique",
							data: [35, 34, 35, 36, 35, 35, 34],
							borderColor: lineChart_3gradientStroke2,
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(254, 176, 25, 1)'
						}, {
							label: "Lavage Brossage",
							data: [70, 70, 68, 69, 67, 70, 70],
							borderColor: lineChart_3gradientStroke3,
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(188, 76, 8, 1)'
						}, {
							label: "Lavage des places",
							data: [20, 20, 22, 21, 25, 25, 20],
							borderColor: lineChart_3gradientStroke4,
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(8, 188, 29, 1)'
						}, {
							label: "Lavage Mécanique",
							data: [18, 20, 18, 16, 15, 15, 16],
							borderColor: lineChart_3gradientStroke5,
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(8, 165, 188, 1)'
						}
					]
				},
				options: {
	...
	var areaChart2 = function(){	
		...
		if(jQuery('#areaChart_2').length > 0 ){
			...
			areaChart_2gradientStroke.addColorStop(0, "rgba(97, 194, 119, 0.2)");
			...
			new Chart(areaChart_2, {
				...
				data: {
					defaultFontFamily: 'Poppins',
					labels: ["Lun", "Mar", "Mer", "Jeu", "Ven", "Sam", "Dem"],
					datasets: [
						{
							label: "My First dataset",
							data: [25, 20, 60, 41, 66, 45, 80],
